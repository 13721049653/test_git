 ...
 */
public class WuziShenListener extends WuziShenInfoListener  implements TaskListener, ExecutionListener {
    private static final Logger log = LoggerFactory.getLogger(WuziShenListener.class);
    /**
     *
     */
